        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="btn-group float-md-right">
                    <button class="btn btn-primary round btn-min-width mr-1 mb-1" type="button" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#addassets"><i class="ft-plus"></i>  <i class="la la-coin"></i> Add Asset</button>
                </div>
            </div>
        </div>
    </div>
