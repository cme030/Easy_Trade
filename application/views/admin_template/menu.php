...
<input type="hidden" id="base" value="<?php echo base_url(); ?>">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" nav-item"><a href="<?php echo base_url(); ?>dashboard"><i class="la la-home"></i><span class="menu-title" data-i18n="Crypto Dashboard">EasyTrade Dashboard</span></a>
          </li>
          <li class=" navigation-header"><span data-i18n="Crypto">Easy Trade</span><i class="la la-ellipsis-h" data-toggle="tooltip" data-placement="right" data-original-title="Crypto"></i>
          </li>
         ...
         <!--  <li class=" nav-item"><a href="<?php echo base_url(); ?>trading"><i class="la la-dollar"></i><span class="menu-title" data-i18n="Trading">Trading</span></a>
          </li> -->
          <li class=" nav-item"><a href="<?php echo base_url(); ?>user_details"><i class="la la-user"></i><span class="menu-title" data-i18n="User">Users</span></a>
          </li>
          <li class=" nav-item"><a href="<?php echo base_url(); ?>coins"><i class="la la-coins"></i><span class="menu-title" data-i18n="Coins"> Coins / Prices</span></a>
          </li>
